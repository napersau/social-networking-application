...
export const postService = {
  ...
  getPostById: async (postId) => {
    return await httpClient.get(
      API.GET_POST_BY_ID || `/api/v1/posts/${postId}`,
      {
        headers: {
          Authorization: `Bearer ${getToken()}`,
        },
  ...
  updatePost: async (postId, postData) => {
    return await httpClient.put(
      API.UPDATE_POST || `/api/v1/posts/${postId}`,
      postData,
      {
        headers: {
          Authorization: `Bearer ${getToken()}`,
  ...
  deletePost: async (postId) => {
    return await httpClient.delete(
      API.ID_POST(postId) || `/api/v1/posts/${postId}`,
      {
        headers: {
          Authorization: `Bearer ${getToken()}`,
        },
  ...
  likePost: async (postId) => {
    return await httpClient.post(
      API.LIKE_POST || `/api/v1/posts/${postId}/like`,
      {},
      {
        headers: {
          Authorization: `Bearer ${getToken()}`,
  ...
  unlikePost: async (postId) => {
    return await httpClient.delete(
      API.UNLIKE_POST || `/api/v1/posts/${postId}/like`,
      {
        headers: {
          Authorization: `Bearer ${getToken()}`,
        },
  ...
  getUserPosts: async (userId) => {
    return await httpClient.get(
      API.GET_USER_POSTS || `/api/v1/posts/user/${userId}`,
      {
        headers: {
          Authorization: `Bearer ${getToken()}`,
        },
  ...
  getPostsByHashtag: async (hashtag) => {
    return await httpClient.get(
      API.GET_POSTS_BY_HASHTAG || `/api/v1/posts/hashtag/${hashtag}`,
      {
        headers: {
          Authorization: `Bearer ${getToken()}`,
        },
  ...
  uploadPostImage: async (formData) => {
    return await httpClient.post(
      API.UPLOAD_POST_IMAGE || "/api/v1/posts/upload-image",
      formData,
      {
        headers: {
          Authorization: `Bearer ${getToken()}`,
  ...
  reportPost: async (postId, reason) => {
    return await httpClient.post(
      API.REPORT_POST || `/api/v1/posts/${postId}/report`,
      { reason },
      {
        headers: {
          Authorization: `Bearer ${getToken()}`,
  ...
  sharePost: async (postId, shareData) => {
    return await httpClient.post(
      API.SHARE_POST || `/api/v1/posts/${postId}/share`,
      shareData,
      {
        headers: {
          Authorization: `Bearer ${getToken()}`,
  ...
  getPostStats: async (postId) => {
    return await httpClient.get(
      API.GET_POST_STATS || `/api/v1/posts/${postId}/stats`,
      {
        headers: {
          Authorization: `Bearer ${getToken()}`,
        },
  ...
  getPostLikes: async (postId, page = 0, size = 10) => {
    return await httpClient.get(
      API.GET_POST_LIKES || `/api/v1/posts/${postId}/likes`,
      {
        params: { page, size },
        headers: {
          Authorization: `Bearer ${getToken()}`,
  ...
  incrementPostView: async (postId) => {
    return await httpClient.post(
      API.INCREMENT_POST_VIEW || `/api/v1/posts/${postId}/view`,
      {},
      {
        headers: {
          Authorization: `Bearer ${getToken()}`,
